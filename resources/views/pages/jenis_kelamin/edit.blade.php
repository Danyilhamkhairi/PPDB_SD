...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Edit Jenis Kelamin</h1>
            <p class="page-subtitle">Perbarui data jenis kelamin dalam sistem</p>
        </div>
        <a href="{{route('jenis_kelamin.index')}}" class="btn btn-warning shadow">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Data Jenis Kelamin</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('jenis_kelamin.update', $data->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_kelamin" value="{{$data->jenis_kelamin}}" name="jenis_kelamin" required>
                        </div>

                        <div class="form-group mt-4 d-flex justify-content-between">
                            <a href="{{route('jenis_kelamin.index')}}" class="btn btn-secondary">Batal</a>
