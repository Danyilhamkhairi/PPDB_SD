...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Manajemen Penghasilan Orangtua</h1>
            <p class="page-subtitle">Kelola daftar penghasilan orangtua untuk pendaftaran peserta</p>
        </div>
        <a href="{{route('penghasilan_ortu.create')}}" class="btn btn-primary shadow">
    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Penghasilan Orangtua</h6>
            ...
            <div class="table-responsive table-container">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="10%">No</th>
                            <th width="55%">Penghasilan Orangtua</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge-income">
                                    <i class="fas fa-money-bill-wave mr-1"></i> Rp {{number_format($item->penghasilan_ortu, 0, ',', '.')}}
                                </span>
                            </td>
                            <td>
                                <a href="{{route('penghasilan_ortu.edit', $item->id)}}" class="btn btn-success btn-action mr-2 shadow-sm">
