...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Edit Penghasilan Orangtua</h1>
            <p class="page-subtitle">Perbarui data penghasilan orangtua dalam sistem</p>
        </div>
                    ...
                    <form action="{{route('penghasilan_ortu.update', $data->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="penghasilan_ortu" value="{{$data->penghasilan_ortu}}" name="penghasilan_ortu" min="0" step="1000" required>
                            </div>
