...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Tambah Penghasilan Orangtua</h1>
            <p class="page-subtitle">Tambahkan data penghasilan orangtua baru ke dalam sistem</p>
        </div>
        <a href="{{route('penghasilan_ortu.index')}}" class="btn btn-warning shadow">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Data Penghasilan Orangtua</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('penghasilan_ortu.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="penghasilan_ortu" class="font-weight-bold">Penghasilan Orangtua</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Rp</span>
                                </div>
                                <input type="number" class="form-control" id="penghasilan_ortu" name="penghasilan_ortu" placeholder="Contoh: 4500000" min="0" step="1000" required>
                            </div>
                            <small class="text-muted">Masukkan nilai penghasilan tanpa tanda titik atau koma</small>
                        </div>

                        <div class="form-group mt-4 d-flex justify-content-between">
                            <a href="{{route('penghasilan_ortu.index')}}" class="btn btn-secondary">Batal</a>
