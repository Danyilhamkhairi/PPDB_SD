...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Tambah Agama</h1>
            <p class="page-subtitle">Tambahkan data agama baru ke dalam sistem</p>
        </div>
                ...
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('agama.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_agama" name="nama_agama" placeholder="Masukkan nama agama" required>
                        </div>
