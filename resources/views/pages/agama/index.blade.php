...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Manajemen Agama</h1>
            <p class="page-subtitle">Kelola daftar agama untuk pendaftaran peserta</p>
        </div>
        <a href="{{route('agama.create')}}" class="btn btn-primary shadow">
            <i class="fas fa-plus fa-sm mr-2"></i>Tambah Agama
        </a>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Agama</h6>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="font-weight-medium">{{$item->nama_agama}}</span>
                            </td>
                            <td>
                                <a href="{{route('agama.edit', $item->id)}}" class="btn btn-success btn-action mr-2 shadow-sm">
                                    <i class="fas fa-edit action-icon"></i> Ubah
                                </a>
                                <form method="post" class="d-inline-block" action="{{route('agama.destroy', $item->id)}}">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="btn btn-danger btn-action shadow-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus agama ini?')">
