...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Edit Jurusan</h1>
            <p class="page-subtitle">Perbarui data jurusan dalam sistem</p>
        </div>
        <a href="{{route('jurusan.index')}}" class="btn btn-warning shadow">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Data Jurusan</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('jurusan.update', $data->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="jurusan" class="font-weight-bold">Nama Jurusan</label>
                            <input type="text" class="form-control" id="jurusan" value="{{$data->jurusan}}" name="jurusan" required>
                        </div>
