...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Pekerjaan Orangtua</h1>
            <p class="page-subtitle">Tambah Data Pekerjaan Orangtua</p>
        </div>
        <a href="{{route('pekerjaan_ortu.index')}}" class="btn btn-warning shadow">
            <i class="fas fa-arrow-left fa-sm mr-2"></i>Back
        </a>
    </div>
                ...
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('pekerjaan_ortu.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="nama_pekerjaan" class="font-weight-bold">Nama Pekerjaan Orangtua</label>
