...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between page-header">
        <div>
            <h1 class="h3 mb-0 page-title">Edit Pekerjaan Orangtua</h1>
            <p class="page-subtitle">Perbarui data pekerjaan orangtua dalam sistem</p>
        </div>
        <a href="{{route('pekerjaan_ortu.index')}}" class="btn btn-warning shadow">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Data Pekerjaan Orangtua</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <form action="{{route('pekerjaan_ortu.update', $data->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="nama_pekerjaan_ortu" class="font-weight-bold">Nama Pekerjaan</label>
                            <input type="text" class="form-control" id="nama_pekerjaan_ortu" value="{{$data->nama_pekerjaan_ortu}}" name="nama_pekerjaan_ortu" required>
                        </div>

                        <div class="form-group mt-4 d-flex justify-content-between">
                            <a href="{{route('pekerjaan_ortu.index')}}" class="btn btn-secondary">Batal</a>
