...
class DashboardController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        // Get associated peserta data
        $peserta = $item->peserta;

        // Delete the hasil record
        $item->delete();

        // Delete the associated peserta data if it exists
        if ($peserta) {
            // Delete associated orang_tua data if it exists
            if ($peserta->orang_tua) {
                $peserta->orang_tua->delete();
            }
        ...
        Alert::success('Sukses', 'Data Peserta Berhasil Dihapus');
        return redirect()->route('home');
    }
}
